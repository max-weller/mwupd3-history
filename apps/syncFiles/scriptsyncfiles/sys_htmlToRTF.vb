...
#End Region
  ...
  :Function replaceHtmlFont(ByVal m As Match) As String
    Dim res = "{"
    For i As Integer = 0 To m.Groups(3).Captures.Count - 1
  ...
  :Sub zoomRTF(ByVal rtb As RichTextBox, ByVal html As String)
    ...
    rtb.ReadOnly = False
    rtb.Rtf = getRTF(html)
    TRACE "htmlCode(2)", rtb.Rtf
    TRACE "htmlCode(2)", rtb.Text
    ...
    Do
      ...
      TRACE rtb.SelectedText,rtb.SelectionStart
